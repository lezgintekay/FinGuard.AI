    ...
    public static class DbSeeder
    {
        public static void SeedData(AppDbContext context)
        {
            ...
            if (!context.Users.Any())
            {
                ...
                context.SaveChanges(); // Save to generate IDs if not identity insert, though SQLite handles it.
            }
            ...
            if (!context.Faturalar.Any())
            {
                context.Faturalar.AddRange(
                    // User 1: Admin
                    new Fatura { FaturaNo = "FTR-001", CariAd = "ABC Lojistik", Tutar = 15000, KesimTarihi = DateTime.Now.AddDays(-10), VadeTarihi = DateTime.Now.AddDays(20), FaturaTipi = "Giden", Durum = "Bekliyor", UserId = 1 },
                    new Fatura { FaturaNo = "FTR-002", CariAd = "XYZ Hammadde", Tutar = 30000, KesimTarihi = DateTime.Now.AddDays(-5), VadeTarihi = DateTime.Now.AddDays(3), FaturaTipi = "Giden", Durum = "Bekliyor", UserId = 1 },
                    
                    // User 2: Scenario A - Critical Risk
                    new Fatura { FaturaNo = "FTR-101", CariAd = "Tedarikçi AŞ", Tutar = 180000, KesimTarihi = DateTime.Now.AddDays(-15), VadeTarihi = DateTime.Now.AddDays(2), FaturaTipi = "Giden", Durum = "Bekliyor", UserId = 2 }, // Huge invoice due very soon vs 10k cash
                    new Fatura { FaturaNo = "FTR-102", CariAd = "Kira", Tutar = 25000, KesimTarihi = DateTime.Now.AddDays(-5), VadeTarihi = DateTime.Now.AddDays(5), FaturaTipi = "Giden", Durum = "Bekliyor", UserId = 2 },
                    
                    // User 3: Scenario B - Safe
                    new Fatura { FaturaNo = "FTR-201", CariAd = "Ofis Kırtasiye", Tutar = 5000, KesimTarihi = DateTime.Now.AddDays(-10), VadeTarihi = DateTime.Now.AddDays(15), FaturaTipi = "Giden", Durum = "Bekliyor", UserId = 3 },
                    new Fatura { FaturaNo = "FTR-202", CariAd = "Danışmanlık", Tutar = 20000, KesimTarihi = DateTime.Now.AddDays(-2), VadeTarihi = DateTime.Now.AddDays(25), FaturaTipi = "Giden", Durum = "Bekliyor", UserId = 3 }
                );
                context.SaveChanges();
            }
